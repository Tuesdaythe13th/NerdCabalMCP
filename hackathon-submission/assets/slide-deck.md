...
**Speaker Notes:**
> "We integrate the entire Circle stack. Arc for settlement, Wallets for custody, Gateway for cross-chain, and Proof to Pay for micropayments."
...
- Arc + Wallets + Gateway + CCTP + Proof to Pay
...
API providers earn with Proof to Pay micropayments
